					...
					<div class="rounded-lg border">
						...
						>
							...
							<div class="flex items-center gap-2">
								...
								<ChevronRightIcon
									class="h-4 w-4 text-muted-foreground transition-transform {expanded === repair.id
										? 'rotate-90'
										: ''}"
								/>
							</div>
			...
			<CardContent class="py-12">
				<div class="flex flex-col items-center text-center text-muted-foreground">
					...
					<p class="mb-4 max-w-sm text-sm">
						Get started by adding your first vehicle. Repairs and estimates will appear here as they
						are created.
					</p>
					<Button variant="outline" onclick={() => goto(resolve('/app/cars'))}>
						<CarIcon class="size-4" />
